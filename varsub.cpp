    ...
    if ((flags & DFLT) == 0) {
      ...
      case 1:
        sprintf(param[1], HUGE_FORMAT,
                UnifInt((int64_t)60, (int64_t)120, qnum));
        param[2][0] = '\0';
        break;
      case 2:
        sprintf(param[1], HUGE_FORMAT,
      ...
      case 4:
        ...
        sprintf(param[1], formats[4], 93 + tmp_date / 12, tmp_date % 12 + 1);
        param[2][0] = '\0';
        break;
      case 5:
      ...
      case 6:
        ...
        sprintf(param[2], formats[7], UnifInt((int64_t)2, (int64_t)9, qnum));
      ...
      case 10:
        ...
        sprintf(param[1], formats[10], 93 + tmp_date / 12, tmp_date % 12 + 1);
        param[2][0] = '\0';
        break;
      case 11:
      ...
      case 14:
        ...
        sprintf(param[1], formats[14], 93 + tmp_date / 12, tmp_date % 12 + 1);
        param[2][0] = '\0';
        break;
      case 15:
        tmp_date = UnifInt((int64_t)0, (int64_t)57, qnum);
        sprintf(param[1], formats[15], 93 + tmp_date / 12, tmp_date % 12 + 1);
        param[2][0] = '\0';
        break;
      case 16:
      ...
      case 18:
        sprintf(param[1], HUGE_FORMAT,
                UnifInt((int64_t)312, (int64_t)315, qnum));
        param[2][0] = '\0';
        break;
      case 19:
        tmp1 = UnifInt((int64_t)1, (int64_t)5, qnum);
